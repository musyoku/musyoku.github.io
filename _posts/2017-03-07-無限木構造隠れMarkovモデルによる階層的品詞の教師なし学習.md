...
$$
	\begin{align}
		\double E[\nu_{\boldsymbol s} \mid {\cal D}] &= \frac
		{
			\alpha\mu'_{\boldsymbol s}+n_0(\boldsymbol s)
		}{
			\alpha(1-\sum_{\boldsymbol u \prec \boldsymbol s}\mu'_{\boldsymbol u})+n_0(\boldsymbol s)+n_1(\boldsymbol s)
		}\\
		\double E[\psi_{\boldsymbol sk} \mid {\cal D}] &= \frac
		{
			\alpha\phi'_{\boldsymbol sk}+m_0(\boldsymbol sk)
		}{
			\alpha(1-\sum_{j=1}^{k-1}\phi'_{\boldsymbol sj})+m_0(\boldsymbol sk)+m_1(\boldsymbol sk)
		}\\
	\end{align}\
$$
